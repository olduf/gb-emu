...
int32_t InstructionArgument::get(Registers* registers, MemorySpace* mmu, int32_t opArgument) const
{
    return this->getOperation(registers, mmu, opArgument);
}

void InstructionArgument::set(Registers* registers, MemorySpace* mmu, int32_t opArgument, int32_t value) const
{
...
const InstructionArgument InstructionArgument::A(
    0,
    [] (Registers* registers, MemorySpace* mmu, int32_t opArgument) -> int32_t {
        return static_cast<int32_t>(registers->getA());
    },
    [] (Registers* registers, MemorySpace* mmu, int32_t opArgument, int32_t value) {
...
const InstructionArgument InstructionArgument::N(
    ...
    [] (Registers* registers, MemorySpace* mmu, int32_t opArgument, int32_t value)  { /*throw*/ }
);
