...
Instruction* instructions[2][256] = {
    ...
    {
        InstructionBuilder(0x00, 4, 1, std::string("CB RLC B")).load(&InstructionArgument::B).rotateLeftAndCarry().store(&InstructionArgument::B).build(),
        InstructionBuilder(0x01, 4, 1, std::string("CB RLC C")).load(&InstructionArgument::C).rotateLeftAndCarry().store(&InstructionArgument::C).build(),
        InstructionBuilder(0x02, 4, 1, std::string("CB RLC D")).load(&InstructionArgument::D).rotateLeftAndCarry().store(&InstructionArgument::D).build(),
        InstructionBuilder(0x03, 4, 1, std::string("CB RLC E")).load(&InstructionArgument::E).rotateLeftAndCarry().store(&InstructionArgument::E).build(),
        InstructionBuilder(0x04, 4, 1, std::string("CB RLC H")).load(&InstructionArgument::H).rotateLeftAndCarry().store(&InstructionArgument::H).build(),
        InstructionBuilder(0x05, 4, 1, std::string("CB RLC L")).load(&InstructionArgument::L).rotateLeftAndCarry().store(&InstructionArgument::L).build(),
        InstructionBuilder(0x06, 12, 1, std::string("CB RLC (HL)")).load(&InstructionArgument::_HL).rotateLeftAndCarry().store(&InstructionArgument::_HL).build(),
        InstructionBuilder(0x07, 4, 1, std::string("CB RLC A")).load(&InstructionArgument::A).rotateLeftAndCarry().store(&InstructionArgument::A).build(),
        InstructionBuilder(0x08, 4, 1, std::string("CB RRC B")).load(&InstructionArgument::B).rotateRightAndCarry().store(&InstructionArgument::B).build(),
        InstructionBuilder(0x09, 4, 1, std::string("CB RRC C")).load(&InstructionArgument::C).rotateRightAndCarry().store(&InstructionArgument::C).build(),
        InstructionBuilder(0x0A, 4, 1, std::string("CB RRC D")).load(&InstructionArgument::D).rotateRightAndCarry().store(&InstructionArgument::D).build(),
        InstructionBuilder(0x0B, 4, 1, std::string("CB RRC E")).load(&InstructionArgument::E).rotateRightAndCarry().store(&InstructionArgument::E).build(),
        InstructionBuilder(0x0C, 4, 1, std::string("CB RRC H")).load(&InstructionArgument::H).rotateRightAndCarry().store(&InstructionArgument::H).build(),
        InstructionBuilder(0x0D, 4, 1, std::string("CB RRC L")).load(&InstructionArgument::L).rotateRightAndCarry().store(&InstructionArgument::L).build(),
        InstructionBuilder(0x0E, 12, 1, std::string("CB RRC (HL)")).load(&InstructionArgument::_HL).rotateRightAndCarry().store(&InstructionArgument::_HL).build(),
        InstructionBuilder(0x0F, 4, 1, std::string("CB RRC A")).load(&InstructionArgument::A).rotateRightAndCarry().store(&InstructionArgument::A).build(),

        InstructionBuilder(0x10, 4, 1, std::string("CB RL B")).load(&InstructionArgument::B).rotateLeft().store(&InstructionArgument::B).build(),
        InstructionBuilder(0x11, 4, 1, std::string("CB RL C")).load(&InstructionArgument::C).rotateLeft().store(&InstructionArgument::C).build(),
        InstructionBuilder(0x12, 4, 1, std::string("CB RL D")).load(&InstructionArgument::D).rotateLeft().store(&InstructionArgument::D).build(),
        InstructionBuilder(0x13, 4, 1, std::string("CB RL E")).load(&InstructionArgument::E).rotateLeft().store(&InstructionArgument::E).build(),
        InstructionBuilder(0x14, 4, 1, std::string("CB RL H")).load(&InstructionArgument::H).rotateLeft().store(&InstructionArgument::H).build(),
        InstructionBuilder(0x15, 4, 1, std::string("CB RL L")).load(&InstructionArgument::L).rotateLeft().store(&InstructionArgument::L).build(),
        InstructionBuilder(0x16, 12, 1, std::string("CB RL (HL)")).load(&InstructionArgument::_HL).rotateLeft().store(&InstructionArgument::_HL).build(),
        InstructionBuilder(0x17, 4, 1, std::string("CB RL A")).load(&InstructionArgument::A).rotateLeft().store(&InstructionArgument::A).build(),
        InstructionBuilder(0x18, 4, 1, std::string("CB RR B")).load(&InstructionArgument::B).rotateRight().store(&InstructionArgument::B).build(),
        InstructionBuilder(0x19, 4, 1, std::string("CB RR C")).load(&InstructionArgument::C).rotateRight().store(&InstructionArgument::C).build(),
        InstructionBuilder(0x1A, 4, 1, std::string("CB RR D")).load(&InstructionArgument::D).rotateRight().store(&InstructionArgument::D).build(),
        InstructionBuilder(0x1B, 4, 1, std::string("CB RR E")).load(&InstructionArgument::E).rotateRight().store(&InstructionArgument::E).build(),
        InstructionBuilder(0x1C, 4, 1, std::string("CB RR H")).load(&InstructionArgument::H).rotateRight().store(&InstructionArgument::H).build(),
        InstructionBuilder(0x1D, 4, 1, std::string("CB RR L")).load(&InstructionArgument::L).rotateRight().store(&InstructionArgument::L).build(),
        InstructionBuilder(0x1E, 12, 1, std::string("CB RR (HL)")).load(&InstructionArgument::_HL).rotateRight().store(&InstructionArgument::_HL).build(),
        InstructionBuilder(0x1F, 4, 1, std::string("CB RR A")).load(&InstructionArgument::A).rotateRight().store(&InstructionArgument::A).build(),

        InstructionBuilder(0x20, 4, 1, std::string("CB SLA B")).load(&InstructionArgument::B).shiftLeftArithmetic().store(&InstructionArgument::B).build(),
        InstructionBuilder(0x21, 4, 1, std::string("CB SLA C")).load(&InstructionArgument::C).shiftLeftArithmetic().store(&InstructionArgument::C).build(),
        InstructionBuilder(0x22, 4, 1, std::string("CB SLA D")).load(&InstructionArgument::D).shiftLeftArithmetic().store(&InstructionArgument::D).build(),
        InstructionBuilder(0x23, 4, 1, std::string("CB SLA E")).load(&InstructionArgument::E).shiftLeftArithmetic().store(&InstructionArgument::E).build(),
        InstructionBuilder(0x24, 4, 1, std::string("CB SLA H")).load(&InstructionArgument::H).shiftLeftArithmetic().store(&InstructionArgument::H).build(),
        InstructionBuilder(0x25, 4, 1, std::string("CB SLA L")).load(&InstructionArgument::L).shiftLeftArithmetic().store(&InstructionArgument::L).build(),
        InstructionBuilder(0x26, 12, 1, std::string("CB SLA (HL)")).load(&InstructionArgument::_HL).shiftLeftArithmetic().store(&InstructionArgument::_HL).build(),
        InstructionBuilder(0x27, 4, 1, std::string("CB SLA A")).load(&InstructionArgument::A).shiftLeftArithmetic().store(&InstructionArgument::A).build(),
        InstructionBuilder(0x28, 4, 1, std::string("CB SRA B")).load(&InstructionArgument::B).shiftRightArithmetic().store(&InstructionArgument::B).build(),
        InstructionBuilder(0x29, 4, 1, std::string("CB SRA C")).load(&InstructionArgument::C).shiftRightArithmetic().store(&InstructionArgument::C).build(),
        InstructionBuilder(0x2A, 4, 1, std::string("CB SRA D")).load(&InstructionArgument::D).shiftRightArithmetic().store(&InstructionArgument::D).build(),
        InstructionBuilder(0x2B, 4, 1, std::string("CB SRA E")).load(&InstructionArgument::E).shiftRightArithmetic().store(&InstructionArgument::E).build(),
        InstructionBuilder(0x2C, 4, 1, std::string("CB SRA H")).load(&InstructionArgument::H).shiftRightArithmetic().store(&InstructionArgument::H).build(),
        InstructionBuilder(0x2D, 4, 1, std::string("CB SRA L")).load(&InstructionArgument::L).shiftRightArithmetic().store(&InstructionArgument::L).build(),
        InstructionBuilder(0x2E, 12, 1, std::string("CB SRA (HL)")).load(&InstructionArgument::_HL).shiftRightArithmetic().store(&InstructionArgument::_HL).build(),
        InstructionBuilder(0x2F, 4, 1, std::string("CB SRA A")).load(&InstructionArgument::A).shiftRightArithmetic().store(&InstructionArgument::A).build(),

        InstructionBuilder(0x30, 4, 1, std::string("CB SWAP B")).load(&InstructionArgument::B).swapNibbles().store(&InstructionArgument::B).build(),
        InstructionBuilder(0x31, 4, 1, std::string("CB SWAP C")).load(&InstructionArgument::C).swapNibbles().store(&InstructionArgument::C).build(),
        InstructionBuilder(0x32, 4, 1, std::string("CB SWAP D")).load(&InstructionArgument::D).swapNibbles().store(&InstructionArgument::D).build(),
        InstructionBuilder(0x33, 4, 1, std::string("CB SWAP E")).load(&InstructionArgument::E).swapNibbles().store(&InstructionArgument::E).build(),
        InstructionBuilder(0x34, 4, 1, std::string("CB SWAP H")).load(&InstructionArgument::H).swapNibbles().store(&InstructionArgument::H).build(),
        InstructionBuilder(0x35, 4, 1, std::string("CB SWAP L")).load(&InstructionArgument::L).swapNibbles().store(&InstructionArgument::L).build(),
        InstructionBuilder(0x36, 12, 1, std::string("CB SWAP (HL)")).load(&InstructionArgument::_HL).swapNibbles().store(&InstructionArgument::_HL).build(),
        InstructionBuilder(0x37, 4, 1, std::string("CB SWAP A")).load(&InstructionArgument::A).swapNibbles().store(&InstructionArgument::A).build(),
        InstructionBuilder(0x38, 4, 1, std::string("CB SRL B")).load(&InstructionArgument::B).shiftRightLogical().store(&InstructionArgument::B).build(),
        InstructionBuilder(0x39, 4, 1, std::string("CB SRL C")).load(&InstructionArgument::C).shiftRightLogical().store(&InstructionArgument::C).build(),
        InstructionBuilder(0x3A, 4, 1, std::string("CB SRL D")).load(&InstructionArgument::D).shiftRightLogical().store(&InstructionArgument::D).build(),
        InstructionBuilder(0x3B, 4, 1, std::string("CB SRL E")).load(&InstructionArgument::E).shiftRightLogical().store(&InstructionArgument::E).build(),
        InstructionBuilder(0x3C, 4, 1, std::string("CB SRL H")).load(&InstructionArgument::H).shiftRightLogical().store(&InstructionArgument::H).build(),
        InstructionBuilder(0x3D, 4, 1, std::string("CB SRL L")).load(&InstructionArgument::L).shiftRightLogical().store(&InstructionArgument::L).build(),
        InstructionBuilder(0x3E, 12, 1, std::string("CB SRL (HL)")).load(&InstructionArgument::_HL).shiftRightLogical().store(&InstructionArgument::_HL).build(),
        InstructionBuilder(0x3F, 4, 1, std::string("CB SRL A")).load(&InstructionArgument::A).shiftRightLogical().store(&InstructionArgument::A).build(),

        InstructionBuilder(0x40, 4, 1, std::string("CB BIT 0,B")).load(&InstructionArgument::B).testBit(0).build(),
        InstructionBuilder(0x41, 4, 1, std::string("CB BIT 0,C")).load(&InstructionArgument::C).testBit(0).build(),
        InstructionBuilder(0x42, 4, 1, std::string("CB BIT 0,D")).load(&InstructionArgument::D).testBit(0).build(),
        InstructionBuilder(0x43, 4, 1, std::string("CB BIT 0,E")).load(&InstructionArgument::E).testBit(0).build(),
        InstructionBuilder(0x44, 4, 1, std::string("CB BIT 0,H")).load(&InstructionArgument::H).testBit(0).build(),
        InstructionBuilder(0x45, 4, 1, std::string("CB BIT 0,L")).load(&InstructionArgument::L).testBit(0).build(),
        InstructionBuilder(0x46, 12, 1, std::string("CB BIT 0,(HL)")).load(&InstructionArgument::B).testBit(0).build(),
        InstructionBuilder(0x47, 4, 1, std::string("CB BIT 0,A")).load(&InstructionArgument::A).testBit(0).build(),
        InstructionBuilder(0x48, 4, 1, std::string("CB BIT 1,B")).load(&InstructionArgument::B).testBit(1).build(),
        InstructionBuilder(0x49, 4, 1, std::string("CB BIT 1,C")).load(&InstructionArgument::C).testBit(1).build(),
        InstructionBuilder(0x4A, 4, 1, std::string("CB BIT 1,D")).load(&InstructionArgument::D).testBit(1).build(),
        InstructionBuilder(0x4B, 4, 1, std::string("CB BIT 1,E")).load(&InstructionArgument::E).testBit(1).build(),
        InstructionBuilder(0x4C, 4, 1, std::string("CB BIT 1,H")).load(&InstructionArgument::H).testBit(1).build(),
        InstructionBuilder(0x4D, 4, 1, std::string("CB BIT 1,L")).load(&InstructionArgument::L).testBit(1).build(),
        InstructionBuilder(0x4E, 12, 1, std::string("CB BIT 1,(HL)")).load(&InstructionArgument::B).testBit(1).build(),
        InstructionBuilder(0x4F, 4, 1, std::string("CB BIT 1,A")).load(&InstructionArgument::A).testBit(1).build(),

        InstructionBuilder(0x50, 4, 1, std::string("CB BIT 2,B")).load(&InstructionArgument::B).testBit(2).build(),
        InstructionBuilder(0x51, 4, 1, std::string("CB BIT 2,C")).load(&InstructionArgument::C).testBit(2).build(),
        InstructionBuilder(0x52, 4, 1, std::string("CB BIT 2,D")).load(&InstructionArgument::D).testBit(2).build(),
        InstructionBuilder(0x53, 4, 1, std::string("CB BIT 2,E")).load(&InstructionArgument::E).testBit(2).build(),
        InstructionBuilder(0x54, 4, 1, std::string("CB BIT 2,H")).load(&InstructionArgument::H).testBit(2).build(),
        InstructionBuilder(0x55, 4, 1, std::string("CB BIT 2,L")).load(&InstructionArgument::L).testBit(2).build(),
        InstructionBuilder(0x56, 12, 1, std::string("CB BIT 2,(HL)")).load(&InstructionArgument::B).testBit(2).build(),
        InstructionBuilder(0x57, 4, 1, std::string("CB BIT 2,A")).load(&InstructionArgument::A).testBit(2).build(),
        InstructionBuilder(0x58, 4, 1, std::string("CB BIT 3,B")).load(&InstructionArgument::B).testBit(3).build(),
        InstructionBuilder(0x59, 4, 1, std::string("CB BIT 3,C")).load(&InstructionArgument::C).testBit(3).build(),
        InstructionBuilder(0x5A, 4, 1, std::string("CB BIT 3,D")).load(&InstructionArgument::D).testBit(3).build(),
        InstructionBuilder(0x5B, 4, 1, std::string("CB BIT 3,E")).load(&InstructionArgument::E).testBit(3).build(),
        InstructionBuilder(0x5C, 4, 1, std::string("CB BIT 3,H")).load(&InstructionArgument::H).testBit(3).build(),
        InstructionBuilder(0x5D, 4, 1, std::string("CB BIT 3,L")).load(&InstructionArgument::L).testBit(3).build(),
        InstructionBuilder(0x5E, 12, 1, std::string("CB BIT 3,(HL)")).load(&InstructionArgument::B).testBit(3).build(),
        InstructionBuilder(0x5F, 4, 1, std::string("CB BIT 3,A")).load(&InstructionArgument::A).testBit(3).build(),

        InstructionBuilder(0x60, 4, 1, std::string("CB BIT 4,B")).load(&InstructionArgument::B).testBit(4).build(),
        InstructionBuilder(0x61, 4, 1, std::string("CB BIT 4,C")).load(&InstructionArgument::C).testBit(4).build(),
        InstructionBuilder(0x62, 4, 1, std::string("CB BIT 4,D")).load(&InstructionArgument::D).testBit(4).build(),
        InstructionBuilder(0x63, 4, 1, std::string("CB BIT 4,E")).load(&InstructionArgument::E).testBit(4).build(),
        InstructionBuilder(0x64, 4, 1, std::string("CB BIT 4,H")).load(&InstructionArgument::H).testBit(4).build(),
        InstructionBuilder(0x65, 4, 1, std::string("CB BIT 4,L")).load(&InstructionArgument::L).testBit(4).build(),
        InstructionBuilder(0x66, 12, 1, std::string("CB BIT 4,(HL)")).load(&InstructionArgument::B).testBit(4).build(),
        InstructionBuilder(0x67, 4, 1, std::string("CB BIT 4,A")).load(&InstructionArgument::A).testBit(4).build(),
        InstructionBuilder(0x68, 4, 1, std::string("CB BIT 5,B")).load(&InstructionArgument::B).testBit(5).build(),
        InstructionBuilder(0x69, 4, 1, std::string("CB BIT 5,C")).load(&InstructionArgument::C).testBit(5).build(),
        InstructionBuilder(0x6A, 4, 1, std::string("CB BIT 5,D")).load(&InstructionArgument::D).testBit(5).build(),
        InstructionBuilder(0x6B, 4, 1, std::string("CB BIT 5,E")).load(&InstructionArgument::E).testBit(5).build(),
        InstructionBuilder(0x6C, 4, 1, std::string("CB BIT 5,H")).load(&InstructionArgument::H).testBit(5).build(),
        InstructionBuilder(0x6D, 4, 1, std::string("CB BIT 5,L")).load(&InstructionArgument::L).testBit(5).build(),
        InstructionBuilder(0x6E, 12, 1, std::string("CB BIT 5,(HL)")).load(&InstructionArgument::B).testBit(5).build(),
        InstructionBuilder(0x6F, 4, 1, std::string("CB BIT 5,A")).load(&InstructionArgument::A).testBit(5).build(),

        InstructionBuilder(0x70, 4, 1, std::string("CB BIT 6,B")).load(&InstructionArgument::B).testBit(6).build(),
        InstructionBuilder(0x71, 4, 1, std::string("CB BIT 6,C")).load(&InstructionArgument::C).testBit(6).build(),
        InstructionBuilder(0x72, 4, 1, std::string("CB BIT 6,D")).load(&InstructionArgument::D).testBit(6).build(),
        InstructionBuilder(0x73, 4, 1, std::string("CB BIT 6,E")).load(&InstructionArgument::E).testBit(6).build(),
        InstructionBuilder(0x74, 4, 1, std::string("CB BIT 6,H")).load(&InstructionArgument::H).testBit(6).build(),
        InstructionBuilder(0x75, 4, 1, std::string("CB BIT 6,L")).load(&InstructionArgument::L).testBit(6).build(),
        InstructionBuilder(0x76, 12, 1, std::string("CB BIT 6,(HL)")).load(&InstructionArgument::B).testBit(6).build(),
        InstructionBuilder(0x77, 4, 1, std::string("CB BIT 6,A")).load(&InstructionArgument::A).testBit(6).build(),
        InstructionBuilder(0x78, 4, 1, std::string("CB BIT 7,B")).load(&InstructionArgument::B).testBit(7).build(),
        InstructionBuilder(0x79, 4, 1, std::string("CB BIT 7,C")).load(&InstructionArgument::C).testBit(7).build(),
        InstructionBuilder(0x7A, 4, 1, std::string("CB BIT 7,D")).load(&InstructionArgument::D).testBit(7).build(),
        InstructionBuilder(0x7B, 4, 1, std::string("CB BIT 7,E")).load(&InstructionArgument::E).testBit(7).build(),
        InstructionBuilder(0x7C, 4, 1, std::string("CB BIT 7,H")).load(&InstructionArgument::H).testBit(7).build(),
        InstructionBuilder(0x7D, 4, 1, std::string("CB BIT 7,L")).load(&InstructionArgument::L).testBit(7).build(),
        InstructionBuilder(0x7E, 12, 1, std::string("CB BIT 7,(HL)")).load(&InstructionArgument::B).testBit(7).build(),
        InstructionBuilder(0x7F, 4, 1, std::string("CB BIT 7,A")).load(&InstructionArgument::A).testBit(7).build(),

        InstructionBuilder(0x80, 4, 1, std::string("CB RES 0,B")).load(&InstructionArgument::B).resetBit(0).store(&InstructionArgument::B).build(),
        InstructionBuilder(0x81, 4, 1, std::string("CB RES 0,C")).load(&InstructionArgument::C).resetBit(0).store(&InstructionArgument::C).build(),
        InstructionBuilder(0x82, 4, 1, std::string("CB RES 0,D")).load(&InstructionArgument::D).resetBit(0).store(&InstructionArgument::D).build(),
        InstructionBuilder(0x83, 4, 1, std::string("CB RES 0,E")).load(&InstructionArgument::E).resetBit(0).store(&InstructionArgument::E).build(),
        InstructionBuilder(0x84, 4, 1, std::string("CB RES 0,H")).load(&InstructionArgument::H).resetBit(0).store(&InstructionArgument::H).build(),
        InstructionBuilder(0x85, 4, 1, std::string("CB RES 0,L")).load(&InstructionArgument::L).resetBit(0).store(&InstructionArgument::L).build(),
        InstructionBuilder(0x86, 12, 1, std::string("CB RES 0,(HL)")).load(&InstructionArgument::_HL).resetBit(0).store(&InstructionArgument::_HL).build(),
        InstructionBuilder(0x87, 4, 1, std::string("CB RES 0,A")).load(&InstructionArgument::A).resetBit(0).store(&InstructionArgument::A).build(),
        InstructionBuilder(0x88, 4, 1, std::string("CB RES 1,B")).load(&InstructionArgument::B).resetBit(1).store(&InstructionArgument::B).build(),
        InstructionBuilder(0x89, 4, 1, std::string("CB RES 1,C")).load(&InstructionArgument::C).resetBit(1).store(&InstructionArgument::C).build(),
        InstructionBuilder(0x8A, 4, 1, std::string("CB RES 1,D")).load(&InstructionArgument::D).resetBit(1).store(&InstructionArgument::D).build(),
        InstructionBuilder(0x8B, 4, 1, std::string("CB RES 1,E")).load(&InstructionArgument::E).resetBit(1).store(&InstructionArgument::E).build(),
        InstructionBuilder(0x8C, 4, 1, std::string("CB RES 1,H")).load(&InstructionArgument::H).resetBit(1).store(&InstructionArgument::H).build(),
        InstructionBuilder(0x8D, 4, 1, std::string("CB RES 1,L")).load(&InstructionArgument::L).resetBit(1).store(&InstructionArgument::L).build(),
        InstructionBuilder(0x8E, 12, 1, std::string("CB RES 1,(HL)")).load(&InstructionArgument::_HL).resetBit(1).store(&InstructionArgument::_HL).build(),
        InstructionBuilder(0x8F, 4, 1, std::string("CB RES 1,A")).load(&InstructionArgument::A).resetBit(1).store(&InstructionArgument::A).build(),

        InstructionBuilder(0x90, 4, 1, std::string("CB RES 2,B")).load(&InstructionArgument::B).resetBit(2).store(&InstructionArgument::B).build(),
        InstructionBuilder(0x91, 4, 1, std::string("CB RES 2,C")).load(&InstructionArgument::C).resetBit(2).store(&InstructionArgument::C).build(),
        InstructionBuilder(0x92, 4, 1, std::string("CB RES 2,D")).load(&InstructionArgument::D).resetBit(2).store(&InstructionArgument::D).build(),
        InstructionBuilder(0x93, 4, 1, std::string("CB RES 2,E")).load(&InstructionArgument::E).resetBit(2).store(&InstructionArgument::E).build(),
        InstructionBuilder(0x94, 4, 1, std::string("CB RES 2,H")).load(&InstructionArgument::H).resetBit(2).store(&InstructionArgument::H).build(),
        InstructionBuilder(0x95, 4, 1, std::string("CB RES 2,L")).load(&InstructionArgument::L).resetBit(2).store(&InstructionArgument::L).build(),
        InstructionBuilder(0x96, 12, 1, std::string("CB RES 2,(HL)")).load(&InstructionArgument::_HL).resetBit(2).store(&InstructionArgument::_HL).build(),
        InstructionBuilder(0x97, 4, 1, std::string("CB RES 2,A")).load(&InstructionArgument::A).resetBit(2).store(&InstructionArgument::A).build(),
        InstructionBuilder(0x98, 4, 1, std::string("CB RES 3,B")).load(&InstructionArgument::B).resetBit(3).store(&InstructionArgument::B).build(),
        InstructionBuilder(0x99, 4, 1, std::string("CB RES 3,C")).load(&InstructionArgument::C).resetBit(3).store(&InstructionArgument::C).build(),
        InstructionBuilder(0x9A, 4, 1, std::string("CB RES 3,D")).load(&InstructionArgument::D).resetBit(3).store(&InstructionArgument::D).build(),
        InstructionBuilder(0x9B, 4, 1, std::string("CB RES 3,E")).load(&InstructionArgument::E).resetBit(3).store(&InstructionArgument::E).build(),
        InstructionBuilder(0x9C, 4, 1, std::string("CB RES 3,H")).load(&InstructionArgument::H).resetBit(3).store(&InstructionArgument::H).build(),
        InstructionBuilder(0x9D, 4, 1, std::string("CB RES 3,L")).load(&InstructionArgument::L).resetBit(3).store(&InstructionArgument::L).build(),
        InstructionBuilder(0x9E, 12, 1, std::string("CB RES 3,(HL)")).load(&InstructionArgument::_HL).resetBit(3).store(&InstructionArgument::_HL).build(),
        InstructionBuilder(0x9F, 4, 1, std::string("CB RES 3,A")).load(&InstructionArgument::A).resetBit(3).store(&InstructionArgument::A).build(),

        InstructionBuilder(0xA0, 4, 1, std::string("CB RES 4,B")).load(&InstructionArgument::B).resetBit(4).store(&InstructionArgument::B).build(),
        InstructionBuilder(0xA1, 4, 1, std::string("CB RES 4,C")).load(&InstructionArgument::C).resetBit(4).store(&InstructionArgument::C).build(),
        InstructionBuilder(0xA2, 4, 1, std::string("CB RES 4,D")).load(&InstructionArgument::D).resetBit(4).store(&InstructionArgument::D).build(),
        InstructionBuilder(0xA3, 4, 1, std::string("CB RES 4,E")).load(&InstructionArgument::E).resetBit(4).store(&InstructionArgument::E).build(),
        InstructionBuilder(0xA4, 4, 1, std::string("CB RES 4,H")).load(&InstructionArgument::H).resetBit(4).store(&InstructionArgument::H).build(),
        InstructionBuilder(0xA5, 4, 1, std::string("CB RES 4,L")).load(&InstructionArgument::L).resetBit(4).store(&InstructionArgument::L).build(),
        InstructionBuilder(0xA6, 12, 1, std::string("CB RES 4,(HL)")).load(&InstructionArgument::_HL).resetBit(4).store(&InstructionArgument::_HL).build(),
        InstructionBuilder(0xA7, 4, 1, std::string("CB RES 4,A")).load(&InstructionArgument::A).resetBit(4).store(&InstructionArgument::A).build(),
        InstructionBuilder(0xA8, 4, 1, std::string("CB RES 5,B")).load(&InstructionArgument::B).resetBit(5).store(&InstructionArgument::B).build(),
        InstructionBuilder(0xA9, 4, 1, std::string("CB RES 5,C")).load(&InstructionArgument::C).resetBit(5).store(&InstructionArgument::C).build(),
        InstructionBuilder(0xAA, 4, 1, std::string("CB RES 5,D")).load(&InstructionArgument::D).resetBit(5).store(&InstructionArgument::D).build(),
        InstructionBuilder(0xAB, 4, 1, std::string("CB RES 5,E")).load(&InstructionArgument::E).resetBit(5).store(&InstructionArgument::E).build(),
        InstructionBuilder(0xAC, 4, 1, std::string("CB RES 5,H")).load(&InstructionArgument::H).resetBit(5).store(&InstructionArgument::H).build(),
        InstructionBuilder(0xAD, 4, 1, std::string("CB RES 5,L")).load(&InstructionArgument::L).resetBit(5).store(&InstructionArgument::L).build(),
        InstructionBuilder(0xAE, 12, 1, std::string("CB RES 5,(HL)")).load(&InstructionArgument::_HL).resetBit(5).store(&InstructionArgument::_HL).build(),
        InstructionBuilder(0xAF, 4, 1, std::string("CB RES 5,A")).load(&InstructionArgument::A).resetBit(5).store(&InstructionArgument::A).build(),

        InstructionBuilder(0xB0, 4, 1, std::string("CB RES 6,B")).load(&InstructionArgument::B).resetBit(6).store(&InstructionArgument::B).build(),
        InstructionBuilder(0xB1, 4, 1, std::string("CB RES 6,C")).load(&InstructionArgument::C).resetBit(6).store(&InstructionArgument::C).build(),
        InstructionBuilder(0xB2, 4, 1, std::string("CB RES 6,D")).load(&InstructionArgument::D).resetBit(6).store(&InstructionArgument::D).build(),
        InstructionBuilder(0xB3, 4, 1, std::string("CB RES 6,E")).load(&InstructionArgument::E).resetBit(6).store(&InstructionArgument::E).build(),
        InstructionBuilder(0xB4, 4, 1, std::string("CB RES 6,H")).load(&InstructionArgument::H).resetBit(6).store(&InstructionArgument::H).build(),
        InstructionBuilder(0xB5, 4, 1, std::string("CB RES 6,L")).load(&InstructionArgument::L).resetBit(6).store(&InstructionArgument::L).build(),
        InstructionBuilder(0xB6, 12, 1, std::string("CB RES 6,(HL)")).load(&InstructionArgument::_HL).resetBit(6).store(&InstructionArgument::_HL).build(),
        InstructionBuilder(0xB7, 4, 1, std::string("CB RES 6,A")).load(&InstructionArgument::A).resetBit(6).store(&InstructionArgument::A).build(),
        InstructionBuilder(0xB8, 4, 1, std::string("CB RES 7,B")).load(&InstructionArgument::B).resetBit(7).store(&InstructionArgument::B).build(),
        InstructionBuilder(0xB9, 4, 1, std::string("CB RES 7,C")).load(&InstructionArgument::C).resetBit(7).store(&InstructionArgument::C).build(),
        InstructionBuilder(0xBA, 4, 1, std::string("CB RES 7,D")).load(&InstructionArgument::D).resetBit(7).store(&InstructionArgument::D).build(),
        InstructionBuilder(0xBB, 4, 1, std::string("CB RES 7,E")).load(&InstructionArgument::E).resetBit(7).store(&InstructionArgument::E).build(),
        InstructionBuilder(0xBC, 4, 1, std::string("CB RES 7,H")).load(&InstructionArgument::H).resetBit(7).store(&InstructionArgument::H).build(),
        InstructionBuilder(0xBD, 4, 1, std::string("CB RES 7,L")).load(&InstructionArgument::L).resetBit(7).store(&InstructionArgument::L).build(),
        InstructionBuilder(0xBE, 12, 1, std::string("CB RES 7,(HL)")).load(&InstructionArgument::_HL).resetBit(7).store(&InstructionArgument::_HL).build(),
        InstructionBuilder(0xBF, 4, 1, std::string("CB RES 7,A")).load(&InstructionArgument::A).resetBit(7).store(&InstructionArgument::A).build(),

        InstructionBuilder(0xC0, 4, 1, std::string("CB SET 0,B")).load(&InstructionArgument::B).setBit(0).store(&InstructionArgument::B).build(),
        InstructionBuilder(0xC1, 4, 1, std::string("CB SET 0,C")).load(&InstructionArgument::C).setBit(0).store(&InstructionArgument::C).build(),
        InstructionBuilder(0xC2, 4, 1, std::string("CB SET 0,D")).load(&InstructionArgument::D).setBit(0).store(&InstructionArgument::D).build(),
        InstructionBuilder(0xC3, 4, 1, std::string("CB SET 0,E")).load(&InstructionArgument::E).setBit(0).store(&InstructionArgument::E).build(),
        InstructionBuilder(0xC4, 4, 1, std::string("CB SET 0,H")).load(&InstructionArgument::H).setBit(0).store(&InstructionArgument::H).build(),
        InstructionBuilder(0xC5, 4, 1, std::string("CB SET 0,L")).load(&InstructionArgument::L).setBit(0).store(&InstructionArgument::L).build(),
        InstructionBuilder(0xC6, 12, 1, std::string("CB SET 0,(HL)")).load(&InstructionArgument::_HL).setBit(0).store(&InstructionArgument::_HL).build(),
        InstructionBuilder(0xC7, 4, 1, std::string("CB SET 0,A")).load(&InstructionArgument::A).setBit(0).store(&InstructionArgument::A).build(),
        InstructionBuilder(0xC8, 4, 1, std::string("CB SET 1,B")).load(&InstructionArgument::B).setBit(1).store(&InstructionArgument::B).build(),
        InstructionBuilder(0xC9, 4, 1, std::string("CB SET 1,C")).load(&InstructionArgument::C).setBit(1).store(&InstructionArgument::C).build(),
        InstructionBuilder(0xCA, 4, 1, std::string("CB SET 1,D")).load(&InstructionArgument::D).setBit(1).store(&InstructionArgument::D).build(),
        InstructionBuilder(0xCB, 4, 1, std::string("CB SET 1,E")).load(&InstructionArgument::E).setBit(1).store(&InstructionArgument::E).build(),
        InstructionBuilder(0xCC, 4, 1, std::string("CB SET 1,H")).load(&InstructionArgument::H).setBit(1).store(&InstructionArgument::H).build(),
        InstructionBuilder(0xCD, 4, 1, std::string("CB SET 1,L")).load(&InstructionArgument::L).setBit(1).store(&InstructionArgument::L).build(),
        InstructionBuilder(0xCE, 12, 1, std::string("CB SET 1,(HL)")).load(&InstructionArgument::_HL).setBit(1).store(&InstructionArgument::_HL).build(),
        InstructionBuilder(0xCF, 4, 1, std::string("CB SET 1,A")).load(&InstructionArgument::A).setBit(1).store(&InstructionArgument::A).build(),

        InstructionBuilder(0xD0, 4, 1, std::string("CB SET 2,B")).load(&InstructionArgument::B).setBit(2).store(&InstructionArgument::B).build(),
        InstructionBuilder(0xD1, 4, 1, std::string("CB SET 2,C")).load(&InstructionArgument::C).setBit(2).store(&InstructionArgument::C).build(),
        InstructionBuilder(0xD2, 4, 1, std::string("CB SET 2,D")).load(&InstructionArgument::D).setBit(2).store(&InstructionArgument::D).build(),
        InstructionBuilder(0xD3, 4, 1, std::string("CB SET 2,E")).load(&InstructionArgument::E).setBit(2).store(&InstructionArgument::E).build(),
        InstructionBuilder(0xD4, 4, 1, std::string("CB SET 2,H")).load(&InstructionArgument::H).setBit(2).store(&InstructionArgument::H).build(),
        InstructionBuilder(0xD5, 4, 1, std::string("CB SET 2,L")).load(&InstructionArgument::L).setBit(2).store(&InstructionArgument::L).build(),
        InstructionBuilder(0xD6, 12, 1, std::string("CB SET 2,(HL)")).load(&InstructionArgument::_HL).setBit(2).store(&InstructionArgument::_HL).build(),
        InstructionBuilder(0xD7, 4, 1, std::string("CB SET 2,A")).load(&InstructionArgument::A).setBit(2).store(&InstructionArgument::A).build(),
        InstructionBuilder(0xD8, 4, 1, std::string("CB SET 3,B")).load(&InstructionArgument::B).setBit(3).store(&InstructionArgument::B).build(),
        InstructionBuilder(0xD9, 4, 1, std::string("CB SET 3,C")).load(&InstructionArgument::C).setBit(3).store(&InstructionArgument::C).build(),
        InstructionBuilder(0xDA, 4, 1, std::string("CB SET 3,D")).load(&InstructionArgument::D).setBit(3).store(&InstructionArgument::D).build(),
        InstructionBuilder(0xDB, 4, 1, std::string("CB SET 3,E")).load(&InstructionArgument::E).setBit(3).store(&InstructionArgument::E).build(),
        InstructionBuilder(0xDC, 4, 1, std::string("CB SET 3,H")).load(&InstructionArgument::H).setBit(3).store(&InstructionArgument::H).build(),
        InstructionBuilder(0xDD, 4, 1, std::string("CB SET 3,L")).load(&InstructionArgument::L).setBit(3).store(&InstructionArgument::L).build(),
        InstructionBuilder(0xDE, 12, 1, std::string("CB SET 3,(HL)")).load(&InstructionArgument::_HL).setBit(3).store(&InstructionArgument::_HL).build(),
        InstructionBuilder(0xDF, 4, 1, std::string("CB SET 3,A")).load(&InstructionArgument::A).setBit(3).store(&InstructionArgument::A).build(),

        InstructionBuilder(0xE0, 4, 1, std::string("CB SET 4,B")).load(&InstructionArgument::B).setBit(4).store(&InstructionArgument::B).build(),
        InstructionBuilder(0xE1, 4, 1, std::string("CB SET 4,C")).load(&InstructionArgument::C).setBit(4).store(&InstructionArgument::C).build(),
        InstructionBuilder(0xE2, 4, 1, std::string("CB SET 4,D")).load(&InstructionArgument::D).setBit(4).store(&InstructionArgument::D).build(),
        InstructionBuilder(0xE3, 4, 1, std::string("CB SET 4,E")).load(&InstructionArgument::E).setBit(4).store(&InstructionArgument::E).build(),
        InstructionBuilder(0xE4, 4, 1, std::string("CB SET 4,H")).load(&InstructionArgument::H).setBit(4).store(&InstructionArgument::H).build(),
        InstructionBuilder(0xE5, 4, 1, std::string("CB SET 4,L")).load(&InstructionArgument::L).setBit(4).store(&InstructionArgument::L).build(),
        InstructionBuilder(0xE6, 12, 1, std::string("CB SET 4,(HL)")).load(&InstructionArgument::_HL).setBit(4).store(&InstructionArgument::_HL).build(),
        InstructionBuilder(0xE7, 4, 1, std::string("CB SET 4,A")).load(&InstructionArgument::A).setBit(4).store(&InstructionArgument::A).build(),
        InstructionBuilder(0xE8, 4, 1, std::string("CB SET 5,B")).load(&InstructionArgument::B).setBit(5).store(&InstructionArgument::B).build(),
        InstructionBuilder(0xE9, 4, 1, std::string("CB SET 5,C")).load(&InstructionArgument::C).setBit(5).store(&InstructionArgument::C).build(),
        InstructionBuilder(0xEA, 4, 1, std::string("CB SET 5,D")).load(&InstructionArgument::D).setBit(5).store(&InstructionArgument::D).build(),
        InstructionBuilder(0xEB, 4, 1, std::string("CB SET 5,E")).load(&InstructionArgument::E).setBit(5).store(&InstructionArgument::E).build(),
        InstructionBuilder(0xEC, 4, 1, std::string("CB SET 5,H")).load(&InstructionArgument::H).setBit(5).store(&InstructionArgument::H).build(),
        InstructionBuilder(0xED, 4, 1, std::string("CB SET 5,L")).load(&InstructionArgument::L).setBit(5).store(&InstructionArgument::L).build(),
        InstructionBuilder(0xEE, 12, 1, std::string("CB SET 5,(HL)")).load(&InstructionArgument::_HL).setBit(5).store(&InstructionArgument::_HL).build(),
        InstructionBuilder(0xEF, 4, 1, std::string("CB SET 5,A")).load(&InstructionArgument::A).setBit(5).store(&InstructionArgument::A).build(),

        InstructionBuilder(0xF0, 4, 1, std::string("CB SET 6,B")).load(&InstructionArgument::B).setBit(6).store(&InstructionArgument::B).build(),
        InstructionBuilder(0xF1, 4, 1, std::string("CB SET 6,C")).load(&InstructionArgument::C).setBit(6).store(&InstructionArgument::C).build(),
        InstructionBuilder(0xF2, 4, 1, std::string("CB SET 6,D")).load(&InstructionArgument::D).setBit(6).store(&InstructionArgument::D).build(),
        InstructionBuilder(0xF3, 4, 1, std::string("CB SET 6,E")).load(&InstructionArgument::E).setBit(6).store(&InstructionArgument::E).build(),
        InstructionBuilder(0xF4, 4, 1, std::string("CB SET 6,H")).load(&InstructionArgument::H).setBit(6).store(&InstructionArgument::H).build(),
        InstructionBuilder(0xF5, 4, 1, std::string("CB SET 6,L")).load(&InstructionArgument::L).setBit(6).store(&InstructionArgument::L).build(),
        InstructionBuilder(0xF6, 12, 1, std::string("CB SET 6,(HL)")).load(&InstructionArgument::_HL).setBit(6).store(&InstructionArgument::_HL).build(),
        InstructionBuilder(0xF7, 4, 1, std::string("CB SET 6,A")).load(&InstructionArgument::A).setBit(6).store(&InstructionArgument::A).build(),
        InstructionBuilder(0xF8, 4, 1, std::string("CB SET 7,B")).load(&InstructionArgument::B).setBit(7).store(&InstructionArgument::B).build(),
        InstructionBuilder(0xF9, 4, 1, std::string("CB SET 7,C")).load(&InstructionArgument::C).setBit(7).store(&InstructionArgument::C).build(),
        InstructionBuilder(0xFA, 4, 1, std::string("CB SET 7,D")).load(&InstructionArgument::D).setBit(7).store(&InstructionArgument::D).build(),
        InstructionBuilder(0xFB, 4, 1, std::string("CB SET 7,E")).load(&InstructionArgument::E).setBit(7).store(&InstructionArgument::E).build(),
        InstructionBuilder(0xFC, 4, 1, std::string("CB SET 7,H")).load(&InstructionArgument::H).setBit(7).store(&InstructionArgument::H).build(),
        InstructionBuilder(0xFD, 4, 1, std::string("CB SET 7,L")).load(&InstructionArgument::L).setBit(7).store(&InstructionArgument::L).build(),
        InstructionBuilder(0xFE, 12, 1, std::string("CB SET 7,(HL)")).load(&InstructionArgument::_HL).setBit(7).store(&InstructionArgument::_HL).build(),
        InstructionBuilder(0xFF, 4, 1, std::string("CB SET 7,A")).load(&InstructionArgument::A).setBit(7).store(&InstructionArgument::A).build()
    }
};
