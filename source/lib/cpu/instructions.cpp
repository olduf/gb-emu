...
Instruction* instructions[2][256] = {
    ...
    },
    {
        ...
        InstructionBuilder(0x46, 16, 2, std::string("CB BIT 0,(HL)")).load(&InstructionArgument::_HL).testBit(0).build(),
        ...
        InstructionBuilder(0x4E, 16, 2, std::string("CB BIT 1,(HL)")).load(&InstructionArgument::_HL).testBit(1).build(),
        ...
        InstructionBuilder(0x56, 16, 2, std::string("CB BIT 2,(HL)")).load(&InstructionArgument::_HL).testBit(2).build(),
        ...
        InstructionBuilder(0x5E, 16, 2, std::string("CB BIT 3,(HL)")).load(&InstructionArgument::_HL).testBit(3).build(),
        ...
        InstructionBuilder(0x66, 16, 2, std::string("CB BIT 4,(HL)")).load(&InstructionArgument::_HL).testBit(4).build(),
        ...
        InstructionBuilder(0x6E, 16, 2, std::string("CB BIT 5,(HL)")).load(&InstructionArgument::_HL).testBit(5).build(),
        ...
        InstructionBuilder(0x76, 16, 2, std::string("CB BIT 6,(HL)")).load(&InstructionArgument::_HL).testBit(6).build(),
        ...
        InstructionBuilder(0x7E, 16, 2, std::string("CB BIT 7,(HL)")).load(&InstructionArgument::_HL).testBit(7).build(),
